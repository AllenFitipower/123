...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Thu Jun 04 10:56:03 CST 2026
--
-- |-----------------------------------------------------------------------|
...
attribute VITAL_LEVEL0 of SRAM_DATA_64x16 : entity is TRUE;
...
architecture behavior of SRAM_DATA_64x16 is
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/SRAM_DATA_64x16",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
