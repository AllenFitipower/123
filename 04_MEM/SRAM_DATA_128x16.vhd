...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Thu Jun 04 11:00:06 CST 2026
--
-- |-----------------------------------------------------------------------|
...
attribute VITAL_LEVEL0 of SRAM_DATA_128x16 : entity is TRUE;

end SRAM_DATA_128x16;
...
architecture behavior of SRAM_DATA_128x16 is
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/SRAM_DATA_128x16",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
