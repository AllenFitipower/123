...
-- 
--       Module Name       :  SRAM_ICACHE1_64x16  
--       Word              :  64                  
--       Bit               :  16                  
--       Byte              :  1                   
--       Mux               :  1                   
...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Thu Jun 04 10:56:20 CST 2026
--
-- |-----------------------------------------------------------------------|
...
attribute VITAL_LEVEL0 of SRAM_ICACHE1_64x16 : entity is TRUE;

end SRAM_ICACHE1_64x16;
...
architecture behavior of SRAM_ICACHE1_64x16 is
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/SRAM_ICACHE1_64x16",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
